...
export async function handleTag(
  ...
  switch (element.name) {
    case 'div':
      return await handleDiv(element, styles);
    case 'p':
      return await handleP(element, level, styles);
    case 'a':
      return await handleA(element, styles);
    case 'ol':
    case 'ul':
      return await handleList(element, level, styles);
    case 'span':
      return await handleSpan(element, styles);
    case 'u':
      return await handleU(element, styles);
    case 'strong':
    case 'b':
      return await handleStrong(element, styles);
    case 's':
      return await handleStriked(element, styles);
    case 'sub':
      return await handleSub(element, styles);
    case 'sup':
      return await handleSup(element, styles);
    case 'i':
    case 'em':
      return await handleI(element, styles);
    case 'br':
      return await handleBr();
    case 'table':
      return await handleTable(element, level, styles);
    case 'h1':
    case 'h2':
    case 'h3':
    case 'h4':
    case 'h5':
    case 'h6':
      return await handleH123456(element, level, styles);
    case 'img':
      return await handleImage(element, styles);
    default:
      return [];
  }
}
